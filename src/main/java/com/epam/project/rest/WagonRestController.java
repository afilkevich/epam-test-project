...
//    }
//
//    // curl -H "Content-Type: application/json" -X POST -d '{"id":"14152","type":"closed
//    // type","depoId":"2","countOfSeat":"38","dateOfBuilder":"2009-10-24"}' -v localhost:8088/wagon/add
//    @ResponseBody
...
//    }
//
//    // curl -H "Content-Type: application/json" -X PUT -d '{"id":"14176","type":"closed
//    // type","depoId":"1","countOfSeat":"38","dateOfBuilder":"2009-10-24"}' -v
//    // localhost:8088/wagon/update
//    @ResponseBody
...
//    @ResponseBody
//    @ResponseStatus(value = HttpStatus.OK)
//    public List<Wagon> getByDate(@PathVariable(value = "from") String from, @PathVariable(value = "to") String to) {
